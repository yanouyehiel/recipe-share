...
<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Sécurisez votre compte en utilisant un mot de passe long et aléatoire') }}
        </p>
    </header>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('Entrer le nouveau mot de passe')" />
